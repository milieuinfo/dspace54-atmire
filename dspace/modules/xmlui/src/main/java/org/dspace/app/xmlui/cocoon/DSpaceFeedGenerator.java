                ...
                implements Configurable, CacheableProcessingComponent, Recyclable
{
    ...
    public SourceValidity getValidity()
    {
        if (this.validity == null)
        {
            try
            {
                ...
                for(Item item : getRecentlySubmittedItems(context,dso, pageNumber))
                {
                    validity.add(item);
                }
    ...
    public void generate() throws IOException, SAXException, ProcessingException
    {
        try
        {
            ...
            feed.populate(ObjectModelHelper.getRequest(objectModel),
                    dso, getRecentlySubmittedItems(context,dso, pageNumber), FeedUtils.i18nLabels);
    ...
    private Item[] getRecentlySubmittedItems(Context context, DSpaceObject dso, int pageNumber)
            throws SQLException
    {

    	// DO NOT CACHE!!! when paging is possible!!
    	recentSubmissionItems = null;
