...
public class DCInputsReader {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (nd.getNodeName().equals("form")) {
                ...
                List<List<Map<String, String>>> pages
                        = new ArrayList<List<Map<String, String>>>(); // the form contains pages
    ...
    private void processPageParts(String formName, String page, Node n, Map<String, String> field)
        ...
        if (missing != null) {
            String msg
                    = "Required field " + missing + " missing on page " + page + " of form " + formName;
    ...
    private String checkForDups(
        ...
        if (matches > 1) {
            err
                    = "Duplicate field " + schema + "." + elem + "." + qual + " detected in form " + formName;
        }
