...
public class BitstreamResource extends Resource
{
    ...
    @GET
    @Path("/{bitstream_id}")
    @ApiOperation(value = "Retrieve a single bitstream by using the internal DSpace bitstream identifier.",
    ...
    public Bitstream getBitstream(
            ...
            @ApiParam( value = "Show additional data for the bitstream.", required = false, allowableValues = "all,parent")
    ...
    @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    @ApiOperation(value = "Retrieve all policies for all bundles in which the bitstream is present, by using the internal DSpace bitstream identifier.",
            response = org.dspace.rest.common.ResourcePolicy[].class
    )
    public ResourcePolicy[] getBitstreamPolicies(
            @ApiParam( value = "The identifier of the bitstream.", required = true )
            @PathParam("bitstream_id") Integer bitstreamId,
    ...
    @GET
    @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    @ApiOperation(value = "Retrieve a list of bitstreams.",
            response = org.dspace.rest.common.Bitstream[].class
    )
    ...
    @ApiOperation(value = "Retrieve a file by using the corresponding DSpace bitstream identifier.",
    ...
    @ApiOperation(value = "Add a policy to all bundles containing the bitstream using the internal DSpace bitstream identifier",
            response = javax.ws.rs.core.Response.class
    )
    public Response addBitstreamPolicy(
            @ApiParam( value = "The identifier of the bitstream.", required = true )
            @PathParam("bitstream_id") Integer bitstreamId,

            @ApiParam(value = "Bitstream policy object", required = true)
    ...
    @Path("/{bitstream_id}")
    @Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    @ApiOperation(value = "Update a bitstream using the internal DSpace bitstream identifier",
            response = javax.ws.rs.core.Response.class
    )
    public Response updateBitstream(
            ...
            @ApiParam(value = "Bitstream object", required = true)
            Bitstream bitstream,
    ...
    @ApiOperation(value = "Update bitstream data using the internal DSpace bitstream identifier",
            response = javax.ws.rs.core.Response.class
    )
    public Response updateBitstreamData(
            ...
            @ApiParam(value = "File object", required = true)
            InputStream is,
    ...
    @DELETE
    @Path("/{bitstream_id}")
    @ApiOperation(value = "Delete bitstream from all bundles using the internal DSpace bitstream identifier",
            response = javax.ws.rs.core.Response.class
    )
            ...
            @Context HttpHeaders headers, @Context HttpServletRequest request) throws WebApplicationException
    {
        ...
        try
        {
            ...
            {
                Bundle.find(context, bundle.getID()).removeBitstream(dspaceBitstream);
            }
    ...
    @ApiOperation(value = "Delete a policy from a bitstream using the internal DSpace bitstream and policy identifier",
            response = javax.ws.rs.core.Response.class
    )
    public Response deleteBitstreamPolicy(
            @ApiParam( value = "The identifier of the bitstream.", required = true )
            @PathParam("bitstream_id") Integer bitstreamId,

            @ApiParam( value = "The identifier of the policy.", required = true )
