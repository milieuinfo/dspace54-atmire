...
public class CommunitiesResource extends Resource
{
    ...
    @GET
    @Path("/{community_id}")
    @ApiOperation(value = "Retrieve a single community by using the internal DSpace community identifier.",
            response = org.dspace.rest.common.Community.class
    )
    @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    public Community getCommunity(
            @ApiParam( value = "The identifier of the community.", required = true )
            @PathParam("community_id") Integer communityId,

            @ApiParam( value = "Show additional data for the community.", required = false, allowMultiple = true, allowableValues = "all,collections,parentCommunity,parentCommunityList,subCommunities,logo")
     ...
     */
    @GET
    @ApiOperation(value = "Retrieve a list of communities.",
            response = org.dspace.rest.common.Community[].class
    )
    @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    public Community[] getCommunities(
            ...
            @ApiParam( value = "The maximum amount of communities shown.", required = false)
            @QueryParam("limit") @DefaultValue("100") Integer limit,

            @ApiParam( value = "The amount of communities to skip.", required = false)
    ...
    @ApiOperation(value = "Retrieve a list of top communities.",
            response = org.dspace.rest.common.Community[].class
    )
    @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    public Community[] getTopCommunities(
            @ApiParam( value = "Show additional data for the community.", required = false, allowMultiple = true, allowableValues = "all,collections,parentCommunity,parentCommunityList,subCommunities,logo")
            @QueryParam("expand") String expand,
    ...
    @ApiOperation(value = "Retrieve a list of collections in a community by using the internal DSpace community identifier.",
            response = org.dspace.rest.common.Collection[].class
    )
    @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    public Collection[] getCommunityCollections(
            @ApiParam( value = "The identifier of the community.", required = true )
            @PathParam("community_id") Integer communityId,
    ...
    @ApiOperation(value = "Retrieve a list of subcommunities in a community by using the internal DSpace community identifier.",
            response = org.dspace.rest.common.Community[].class
    )
    @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    public Community[] getCommunityCommunities(
            @ApiParam( value = "The identifier of the community.", required = true )
            @PathParam("community_id") Integer communityId,
     ...
     */
    @POST
    @ApiOperation(value = "Create a top level community.",
            response = org.dspace.rest.common.Community.class
    )
    ...
    @POST
    @Path("/{community_id}/collections")
    @ApiOperation(value = "Create a collection in a community by using the internal DSpace community identifier.",
            response = org.dspace.rest.common.Collection.class
    )
    @Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    public Collection addCommunityCollection(
            @ApiParam( value = "The identifier of the community.", required = true )
            @PathParam("community_id") Integer communityId,
    ...
    @POST
    @Path("/{community_id}/communities")
    @ApiOperation(value = "Create a subcommunity in a community by using the internal DSpace community identifier.",
            response = org.dspace.rest.common.Community.class
    )
    @Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    public Community addCommunityCommunity(
            @ApiParam( value = "The identifier of the community.", required = true )
            @PathParam("community_id") Integer communityId,

            @ApiParam(value = "Community object", required = true)
            Community community,
    ...
    @PUT
    @Path("/{community_id}")
    @ApiOperation(value = "Update a community by using the internal DSpace community identifier.",
     ...
     */
    @DELETE
    @ApiOperation(value = "Delete a community by using the internal DSpace community identifier.",
            response = Response.class
    )
    @Path("/{community_id}")
     ...
     */
    @DELETE
    @ApiOperation(value = "Delete a collection in a community by using the internal DSpace community and collection identifiers.",
            response = Response.class
    )
     ...
     */
    @DELETE
    @ApiOperation(value = "Delete a subcommunity in a community by using the internal DSpace community identifiers.",
            response = Response.class
    )
    @Path("/{community_id}/communities/{community_id2}")
    public Response deleteCommunityCommunity(
            @ApiParam( value = "The identifier of the community.", required = true )
            @PathParam("community_id") Integer parentCommunityId,

            @ApiParam( value = "The identifier of the subcommunity.", required = true )
            @PathParam("community_id2") Integer subcommunityId,
